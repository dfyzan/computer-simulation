...
#include "PiCalculation/PiCalcVieta.cpp"
#include "PiCalculation/PiCalcVallis.cpp" //PiCalcVallisNumDenum
...
int main() {
    ...
    pi = PiCalcVallisNumDenum(precision); //For now, you should insert here PiCalc* function from PiCalculation folder
